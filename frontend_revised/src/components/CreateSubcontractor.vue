        ...
        <div class="col-md-8"> 
            ...
            <form @submit.prevent="handleSubmitForm">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input  type="text" class="form-control" id="inputFName" pattern="[A-Za-z\s]{1,20}" v-model="subcontractor.subcontractor_fname" required>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input  type="text" class="form-control" id="inputLName" pattern="[A-Za-z\s]{5,20}" v-model="subcontractor.subcontractor_lname" required>
                    <p style="color:red; font-weight:bold">Required letters only</p>
                </div>
        

                 <div class="form-group col-md-4">
                    <label style ="font-size:14pt" for="inputShortNotes">Subcontractor Trade</label>
                    <textarea type="text" class="form-control" id="inputShortNotes" maxlength="60"   rows="3" v-model="subcontractor_trade" ></textarea>
